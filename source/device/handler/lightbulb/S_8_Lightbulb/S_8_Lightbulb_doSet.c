 ...
 * 取值: 1 或　0
 */
static void P_9_On_doSet(PropertyOperation *o)
{
    // TODO: 执行写操作
    o->status = HAP_OK;
    printf("P_9_On_doSet: %d\n", (int) o->value->data.number->value.intValue);
}
 ...
 */
static void P_10_Brightness_doSet(PropertyOperation *o)
{
    // TODO: 执行写操作
    o->status = HAP_OK;

    printf("P_10_Brightness_doSet: %d\n", (int) o->value->data.number->value.intValue);
}
